...
export default function Home() {
  return (
    <main className="bg-black min-h-screen w-full">
      <HeroSection />
      <FastLaneSection />
      <div className="w-full h-24 md:h-32 bg-gradient-to-b from-transparent via-purple-900/40 to-gray-950/90 blur-sm pointer-events-none -mb-8 md:-mb-16" aria-hidden="true" />
